...
#else
	__extension__ typedef long long int ALint64;
	__extension__ typedef unsigned long long int ALuint64;
#endif

extern void* rg_malloc(size_t size);
extern void rg_free(void *p);
extern void* rg_realloc(void *p, size_t size);
extern char* rg_strdup(char const* source);
extern void* rg_calloc(size_t count, size_t size);
