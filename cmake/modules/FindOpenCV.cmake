...
#
# Rui Varela 04.08.2010
# - First seach on environment variable
# - Find libs with no sufix (static libs case)
#
# Rui Varela 20.12.2010
# - Find libs on ubuntu system
...
if(EXISTS "${OpenCV_DIR}")
        ...
        #Otherwise it try to guess it.
                ...
                set(CVLIB_SUFFIX "${OpenCV_VERSION_MAJOR}${OpenCV_VERSION_MINOR}${OpenCV_VERSION_PATCH}")			
		SET(OpenCV_INCLUDE_DIRS "${OpenCV_DIR}/include" "${OpenCV_INCLUDE_DIR}")
        ...
        foreach(__CVLIB ${OPENCV_LIB_COMPONENTS})
                ...
                find_library(OpenCV_${__CVLIB}_LIBRARY_DEBUG NAMES "${__CVLIB}d" "${__CVLIB}${CVLIB_SUFFIX}d" "lib${__CVLIB}d" "lib${__CVLIB}${CVLIB_SUFFIX}d" PATHS "${OpenCV_DIR}/lib" NO_DEFAULT_PATH)
                find_library(OpenCV_${__CVLIB}_LIBRARY_RELEASE NAMES "${__CVLIB}" "${__CVLIB}${CVLIB_SUFFIX}" "lib${__CVLIB}" "lib${__CVLIB}${CVLIB_SUFFIX}" PATHS "${OpenCV_DIR}/lib" NO_DEFAULT_PATH)
